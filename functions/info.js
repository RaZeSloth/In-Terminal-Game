module.exports.info = function info() {
    (async () => {
        ...
        const chalk = require('chalk'), prompts = require('prompts'), { connection } = require('../database/db'), md = require('console-markdown'), fs = require("fs"), { menu } = require('../functions/menu')
