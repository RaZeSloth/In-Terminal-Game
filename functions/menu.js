module.exports.menu = function menu() {
  (async () => {
   ...
   const chalk = require('chalk'), prompts = require('prompts'), { login } = require('../functions/login'), { register } = require('../functions/register'), { settings } = require('../functions/settings'), { info } = require('../functions/info')
